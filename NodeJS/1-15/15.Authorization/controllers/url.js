...
async function createShortUrl(req, res) {
    ...
    try {
        ...
        const newUrl = new Url({ 
             ...
             shortUrl, 
             visitHistory: [], 
             createdBy: req.user._id }); //req.user ta middleware theke asbe ./middleware/auth.js -> req.user = user; jekhane user ta session theke asche r _id ta mongoose objectId 
